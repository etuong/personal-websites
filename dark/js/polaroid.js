...
google.setOnLoadCallback(function()
{
	...
	$(".polaroid").draggable({
		...
		start: function(event, ui) {
			dragging = true;
			zindexnr++;
			var cssObj = { 'box-shadow' : '#888 3px 4px 8px', // added in case CSS3 is standard
				'-webkit-box-shadow' : '#888 3px 4px 8px', // safari only
				'-moz-box-shadow' : '#888 3px 4px 8px', // firefox only
				'padding-left' : '-4px',
				'padding-top' : '-4px',
				'z-index' : zindexnr };
			$(this).css(cssObj);
