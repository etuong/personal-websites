...
jQuery.fn.imgbubbles=function(options){
	...
	return this.each(function(){ //return jQuery obj
		...
		$imgs.each(function(){
			...
			if ($img.attr('alt')){ //if tooltip for image defined
				...
				var tipd={width:$tip.outerWidth(), height:$tip.outerHeight()-4} //tip dimensions
				$tip.data("specs", {
					d: tipd,
	...
	$(".bubblewrap img").click(function () {$("img").css("border", "none");$(this).css("border", "2px solid white");});
