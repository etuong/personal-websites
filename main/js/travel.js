$(function () {
  ...
  var sites = [
    {
      ...
      title: "Paris, France",
      html: template
        .replace("$pic", "paris.jpg")
        .replace("$title", "Paris, France")
        .replace("$bgColor", "#313d52")
        .replace(
          "$desc",
          "This city does not need any introduction. Paris is one of the most beautiful cities in the world. It is known worldwide for the Louvre Museum, Notre-Dame cathedral, and the Eiffel tower. It has a reputation of being a romantic and cultural city. The city is also known for its high-quality gastronomy and the terraces of its cafés."
        ),
    },
    {
      lat: 42.3601,
    ...
    },
    {
      ...
      title: "Vatican City",
      html: template
        .replace("$pic", "vatican.jpg")
        .replace("$title", "asdf")
        .replace("$bgColor", "#c58459")
        .replace(
          "$desc",
          "Vatican City, a city-state surrounded by Rome, Italy, is the headquarters of the Roman Catholic Church. It's home to the Pope and a trove of iconic art and architecture. Its Vatican Museums house ancient Roman sculptures as well as Renaissance frescoes in the Raphael Rooms and the Sistine Chapel, famous for Michelangelo's ceiling. Fun fact, the Vatican City is the smallest country in the world!"
        ),
    },
    {
      lat: 34.2666656,
    ...
    },
    {
      ...
      html: template
        .replace("$pic", "tasmania.jpg")
        .replace("$title", "Tasmania, Australia")
        .replace("$bgColor", "#baa884")
        .replace(
          "$desc",
          "Tasmania is Australia's only island state and the smallest land area and population. About 12,000 years ago sea level rises and separated Tasmania from the mainland. You'll see lots of brick prisons built by convicts themselves. These convicts overpopulated British's prisons and were sent to Australia when the continent was found. A roadtrip from Hobart to Launceston will give you an idea of how peaceful and beautiful this island state is."
        ),
    },
    {
      lat: 52.740178,
    ...
    },
    {
      ...
      html: template
        .replace("$pic", "seattle.jpg")
        .replace("$title", "Seattle, Washington, USA")
        .replace("$bgColor", "darkgreen")
        .replace(
          "$desc",
          "Seattle is a very hip, artistic, and modern city with great prominence in technology. Summer is absolutely the best time to visit. There is a great varity of activities to do including eating and trying delicious food at the Pike Place market and observing the city on the Space Needle."
        ),
    },
    {
      lat: 39.922478,
      ...
      title: "Beijing, China",
      html: template
        .replace("$pic", "beijing.jpg")
        .replace("$title", "Beijing, China")
        .replace("$bgColor", "#ddd9d5")
        .replace(
          "$desc",
          'Beijing, also known as Peking, is the capital of the People\'s Republic of China. Beijing has been the political center of the country for much of the past eight centuries. The name Beijing, which means "Northern Capital" was applied to the city in 1403 during the Ming Dynasty to distinguish the city from Nanjing (the "Southern Capital"). Some must visit attractions are Great wall and Forbidden City.'
        ),
    },
    {
      lat: 52.520008,
      ...
      html: template
        .replace("$pic", "berlin.jpg")
        .replace("$title", "Berlin, Germany")
        .replace("$bgColor", "#decb9c")
        .replace(
          "$desc",
          "Berlin is the capital city of Germany and one of the 16 states of the Federal Republic of Germany. Berlin is known for many things, but during my visit, some of the things that stood out for me were its historical associations as the German capital and history, internationalism and tolerance, architecture and street art, and numerous museums, bars, and cafes. The reunification of the country after the fall of the Berlin Wall in 1989 restored classical and medieval buildings as well as introduced ultramodern architecture (Potsdamer Platz)."
        ),
    },
    {
      lat: 34.0522,
    ...
    },
    {
      ...
      html: template
        .replace("$pic", "bruges.jpg")
        .replace("$title", "Bruges, Belgium")
        .replace("$bgColor", "#3b4749")
        .replace(
          "$desc",
          "With beautiful squares surrounded by gingerbread houses and cobbled alleys running alongside pretty canals, Bruges is a city adored by lovebirds. They flock to the Belgian town for its picturesque parks, old world hotels and sentimental legends. Bruges is only an hour away from Brussels and is a must stop! This is one of my favorite places in Europe. It is so quaint and beautiful!"
        ),
    },
    {
      lat: 41.8781,
    ...
    },
    {
      ...
      html: template
        .replace("$pic", "istanbul.jpg")
        .replace("$title", "Istanbul, Turkey")
        .replace("$bgColor", "#e29c48")
        .replace(
          "$desc",
          "Istanbul is Turkey's most populous city as well as its cultural and financial hub. Istanbul is a city where you can have a European experience with an Islamic grace. Spires and domes of mosques, medival architecture dominate the skyline. I recommend an itinerary of 2-3 days to check out the Blue Mosque and Hagia Sophia. For a more authentic Turkish experience, visit a hamam which is a Turkish bathhouse where a massage feels like a brutal beatdown."
        ),
    },
    {
      lat: 50.85034,
    ...
    },
    {
      ...
      html: template
        .replace("$pic", "dallas.jpg")
        .replace("$title", "Dallas, Texas, USA")
        .replace("$bgColor", "#274c5d")
        .replace(
          "$desc",
          "Dallas is the ninth-largest city and part of the fourth-largest metropolitan area in the nation. Did you know that the frozen margarita machine was invented in Dallas. What is really cool about this metropolitan is that it also includes Fort Worth and Arlington, making the area more touristy. Many companies are headquarted around here such as American Airlines and Exxon Mobil."
        ),
    },
    {
      lat: 34.7973,
    ...
    },
    {
      ...
      html: template
        .replace("$pic", "northnz.jpg")
        .replace("$title", "North Island, New Zealand")
        .replace("$bgColor", "#070906")
        .replace(
          "$desc",
          "North Island is one of the two main islands of New Zealand. It is the world's 14th largest island with a population of 3,366,100. With Auckland (\"The City of Sails\" ) as its largest city, North Island constitutes over 76% of the country's population. In contrary to South Islands beautiful alps and adventures, North Island ranges from lushful sceneries to Lord of the Ring landscape and active volcanic peaks. According to the Māori mythology, the island was created after the demigod Māui's brothers chopped a fish he caught during a fishing trip."
        ),
    },
    {
      lat: 50.0755,
    ...
    },
    {
      ...
      title: "Banff, Canada",
      html: template
        .replace("$pic", "banff.jpg")
        .replace("$title", "Banff, Canada")
        .replace("$bgColor", "#57779a")
        .replace(
          "$desc",
          "Banff National Park is famous for its surreally coloured lakes, majestic mountains and endless outdoor adventures. Canada's first national park and the world's third, it has a rich heritage as one of the world's most awe-inspiring mountain destinations. I went during non-summer time so I witnessed whiteness and snow at Lake Louise but I hear it is even more beautiful in the summer!"
        ),
    },
    {
      lat: 18.7061,
      ...
      html: template
        .replace("$pic", "chiangmai.jpg")
        .replace("$title", "Chiang Mai, Thailand")
        .replace("$bgColor", "#5d5b32")
        .replace(
          "$desc",
          "Chiang Mai is a major city in Northern Thailand. It is surrounded by mountains and lush countryside, much greener and quieter than the capital, and has a cosmopolitan air and a significant expat population. In ancient days, it was the capital of the Lanna kingdom. The city walls still exist today and serve as a major attraction with night bazzars and delicious cheap food. This region is also well known for elephant sanctuaries. No visit is complete without giving these elephants a mud bath!"
        ),
    },
    {
      lat: 37.7749,
      ...
      html: template
        ...
        .replace(
          "$desc",
          "San Francisco is a major city in California known for its hilly terrain, liberal community, a world famous bridge, and great diversity. After WWII, San Francisco, being the heart of the Bay area, also became the centerpiece for the gay men and hippie movement. The metro system (BART) is very efficient and there are so many things to do such as enjoying a beautiful walk across the Golden Gate Bridge, eating great seafood at the Fisherman's Wharf, and hitching a ride on a cable car! San Francisco is definitely a top tourist spot on my list!"
        ),
    },
    {
      lat: 37.38264,
    ...
    },
    {
      ...
      html: template
        .replace("$pic", "phuket.jpg")
        .replace("$title", "Phuket, Thailand")
        .replace("$bgColor", "#cbbda0")
        .replace(
          "$desc",
          "Phuket is a tourist island in Thailand. It was on one of the major trading routes between India and China in the early days but now enjoys great popularity as a travel destination. Many great films including Leonardo Dicaprio's The Beach and James Bond movie were filmed here. Snorkeling and a day trip to an exclusive island is highly recommended. "
        ),
    },
    {
      lat: 42.3314,
      ...
      html: template
        .replace("$pic", "detroit.jpg")
        .replace("$title", "Detroit, Michigan, USA")
        .replace("$bgColor", "#545456")
        .replace(
          "$desc",
          "Detroit, in my opinion, is very underrated. I think this city is a gem to the nation. It has been through a lot but still thriving in entertainment and tourism. Motown music and techno were both invented in Detroit. The city is also home to one of the biggest African American population. If you are into automotive, Detroit is a must visit. The Belle Isle park and Eastern market were my two favorite places to go in Detroit!"
        ),
    },
    {
      lat: 30.1534,
  ...
  $(window).on("load", function () {
    ...
    for (var i = 0; i < sites.length; i++) {
      createMarker(
        new google.maps.LatLng(sites[i].lat, sites[i].lon),
        sites[i].flag,
        sites[i].title,
        sites[i].html,
        i * 200 + 500
