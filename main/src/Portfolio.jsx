      ...
      <div className="section-inner custom-page-content">
        ...
        <div className="page-content">
          <ul id="portfolio_filters" className="portfolio-filters">
            ...
            <li>
              <a className="filter btn btn-sm btn-link" data-group="code">
                Code
              </a>
            </li>
            <li>
              <a className="filter btn btn-sm btn-link" data-group="photo">
                Photography
              </a>
            </li>
            <li>
              <a className="filter btn btn-sm btn-link" data-group="hdr">
                HDR
              </a>
            </li>
            <li>
              <a className="filter btn btn-sm btn-link" data-group="shop">
                Photoshop
              </a>
            </li>
            <li>
              <a className="filter btn btn-sm btn-link" data-group="solid">
                SolidWorks
              </a>
            </li>
          </ul>
              ...
              .map((asset, index) => {
                return (
                  <figure
                    key={index}
                    className="item"
                    data-groups={`["all", "${asset.category}"]`}
                  >
                    <a
                      className={
                        asset.page ? "ajax-page-load" : "d-block h-100"
                      }
                      data-fancybox={`${asset.category}`}
                      href={
                        asset.page
                          ? `pages/project/${asset.page}.html`
                          : `images/portfolio/${asset.href}L.jpg`
                      }
                    >
                      <img
                        className="img-fluid img-thumbnail"
                        src={`images/portfolio/${asset.href}S.jpg`}
                        alt=""
                      />
                      <div>
