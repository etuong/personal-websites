$(document).ready(function () {
  ...
  if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
    $('.navbar-brand').attr("href", "#topLink").text("Ethan Uong").addClass("js-scroll-trigger");
  };
  ...
  var mixer = mixitup(document.querySelector('#gallery'), {
    load: {
      sort: 'random',
      filter: '*'
    },
  ...
  $(function () {
    var template = '<div class="card mb-4"><img class="card-img-top" src="assets/images/sites/$pic"><h5 class="card-title" style="background-color:$bgColor;color:white;padding:2px 10px;">$title</h5><div class="card-body"><p class="card-text">$desc</p></div></div>';
    ...
    var iconBase = 'assets/images/flags/';
  ...
  $(function () {
    var location = new google.maps.LatLng(41.093842, -85.139236);
    var mapCanvas = document.getElementById('googlemap');
    var mapOptions = {
      center: new google.maps.LatLng(41, -84.929),
      zoom: 10,
      panControl: false,
      mapTypeId: google.maps.MapTypeId.ROADMAP
    }
    ...
    var contentString = '<div><h4>Residency</h4>' +
      '<div class="info-content">' +
      '<p>I am currently residing here! Fort Wayne is a city in the state of Indiana and the seat of Allen County, United States It is consistently ranked as one of the cheapest places to live in America with a high quality of life.</p>' +
      '</div></div>';
